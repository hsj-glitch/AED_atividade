public class MeuArrayDinamico {
    ...
    private void resize () {
        int ArrLength = this.dados.length;    // vê tamanho original da lista
        int[] NovoArray = new int[ArrLength*2];    // cria nova lista com o dobro do tamanho
    // copia valores para a nova lista
        for (int i = 0; i < ArrLength; i++) {
            NovoArray[i] = dados[i];
        }
    // atribui a lista nova à variável antiga
    ...
    // TODO 2a: se tamanho == dados . length , chame resize ()
        if (this.tamanho == this.dados.length) { resize(); }
    ...
    public static void main ( String [] args ) {
        ...
        // ... continuacao do main do Exercicio 1 ...
